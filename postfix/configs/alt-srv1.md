...
### Основные параметры
- **IP-адрес:** `192.168.254.128`
- **Имя хоста (myhostname):** `mail1.example.com`
- **Домен:** `example.com`
- **Локальный пользователь:** `leo_srv1`
...
mynetworks = 127.0.0.1/32 192.168.254.0/24
...
```bash
leo_srv1@example.com  local:
leo_srv2@example.com  smtp:[10.0.0.12]
```
...
```bash
useradd -m -s /bin/false leo_srv1
passwd leo_srv1
usermod -a -G mail leo_srv1
mkdir -p /home/leo_srv1/Maildir/{cur,new,tmp}
chown -R leo_srv1:mail /home/leo_srv1/Maildir
chmod -R 750 /home/leo_srv1/Maildir
```
